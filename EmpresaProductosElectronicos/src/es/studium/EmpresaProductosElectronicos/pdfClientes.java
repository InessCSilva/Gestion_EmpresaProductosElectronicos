...
{
	public static final String DATA = "FicheroConsultasClientes.txt";
	public static final String DEST = "ConsultaClientes.pdf";

	public pdfClientes(String dest) throws IOException
	{
			...
			Table table = new Table(UnitValue.createPercentArray(new float[] { 1, 3, 4, 3, 1, 1, 1, 3, 4, 2, 2 })).useAllAvailableWidth();
			
			BufferedReader br = new BufferedReader(new FileReader(DATA));
			String line = br.readLine();
			process(table, line, font, true);
			document.add(new Paragraph("Clientes Empresa Productos Electrónicos").setFont(bold));
